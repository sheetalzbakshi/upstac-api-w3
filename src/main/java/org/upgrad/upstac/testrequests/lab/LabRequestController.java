...
import static org.upgrad.upstac.exception.UpgradResponseStatusException.*;
...
public class LabRequestController {
    ...
    public List<TestRequest> getForTests()  {
        ...
        List<TestRequest> list = null;
        try {
            list = testRequestQueryService.findBy(RequestStatus.INITIATED);
        }
        ...
        if(list == null)
            throw asNotFound("No tests were found");
    ...
    public List<TestRequest> getForTester()  {
        ...
        try {
            ...
            list = testRequestQueryService.findByTester(user);
        }
        catch (ConstraintViolationException e) {
            throw asConstraintViolation(e);
        }
